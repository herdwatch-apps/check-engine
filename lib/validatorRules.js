...
module.exports = {
    ...
    'native-run': {
        versionCheck: "native-run --version",
        versionValidate
    },
    appcenter: {
        versionCheck: "appcenter -v",
        versionValidate
    },
    phrase: {
        versionCheck: "phrase version",
        versionValidate
    },
    fastlane: {
        versionCheck: "fastlane -v",
        versionValidate
    },
    gradle: {
        versionCheck: "gradle -v",
        versionValidate
    },
    jenv: {
        versionCheck: "jenv version",
        versionValidate
    },
    sdkmanager: {
        versionCheck: "sdkmanager --version",
        versionValidate
    },
    electron: {
        versionCheck: "electron -v",
        versionValidate
    },
    ruby: {
        versionCheck: "ruby -v",
    ...
    revopush: {
        versionCheck: "revopush -v",
        versionValidate
    },
    firebase: {
        versionCheck: "firebase --version",
        versionValidate
    },
};
